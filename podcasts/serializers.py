...
from userfeatures.models import EpisodeLike, PodcastLike, EpisodeSavePoint
...
class PodcastSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Podcast
        fields = ['name', 'rss_feed', 'image_url', 'description', 'author', 'num_likes', 'cur_user_liked', 'cur_user_flagged']
...
class PodcastSerializerSmall(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['name', 'image_url', 'rss_feed', 'pk', 'description', 'author', 'num_likes']
